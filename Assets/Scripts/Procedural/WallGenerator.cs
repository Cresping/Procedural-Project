...
namespace HeroesGames.ProjectProcedural.Procedural
{
    ...
    {
        /// <summary>
        /// M�dulo encargado de crear los muros dadas las posiciones del suelo y un mapa
        /// </summary>
        /// <param name="floorPositions">Posiciones del suelo</param>
        /// <param name="tilemapVisualizer">Mapa donde se pintar�n los muros</param>
        ...
        /// <summary>
        /// M�dulo encargado de devolver las posiciones de los muros en el mapa
        /// </summary>
        /// <param name="floorPositions">Posiciones del suelo</param>
