...
namespace HeroesGames.ProjectProcedural.Pathfind
{
    ...
    {
        /// <summary>
        /// Devuelve la lista de puntos que se deben de recorrer para llegar a la posici�n deseada
        /// </summary>
        /// <param name="grid"> El conjunto de nodos</param>
        /// <param name="startPos">Posici�n inicial</param>
        ...
        /// <summary>
        /// Devuelve la lista de nodos que se deben de recorrer para llegar a la posici�n deseada
        /// </summary>
        /// <param name="grid">El conjunto de nodos</param>
        /// <param name="startPos">Posici�n inicial</param>
        /// <param name="targetPos">Posici�n final</param>
        ...
        /// <summary>
        /// M�dulo encargado de volver atras en la lista de nodos
        /// </summary>
        /// <param name="grid">El conjunto de nodos</param>
